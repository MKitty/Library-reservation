        ...
        return(
            ...
            <Modal title="新建用户" visible={this.state.visible} onCancel={this.handleOk} onOk={this.handleOk}>
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <FormItem {...formItemLayout} label="学币" hasFeedback>
                        {getFieldDecorator('learnc',{
                            rules:[{required:true,message:'请输入学币'}]
                        })(
                            <Input type="textarea" rows={3} placeholder="请输入学币!"/>
                        )}
                    </FormItem>
                    <FormItem {...formItemLayout} label="组别" hasFeedback>
