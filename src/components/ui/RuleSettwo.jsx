...
import Drags from './Draggable.jsx';
import BreadcrumbCustom from '../BreadcrumbCustom';
const TabPane = Tabs.TabPane;

class RuleSettwo extends React.Component {
constructor(props) {
    super(props);
    this.newTabIndex = 0;
    const panes = [
        { title: '图书馆1', content: <Drags/>, key: '1' },
        { title: '图书馆2', content: <Drags/>, key: '2' },
...
add = () => {
    ...
    panes.push({ title:<input/>, content: <Drags/>, key: activeKey });
...
remove = (targetKey) => {
    ...
    render() {
        ...
        return (
            ...
            <BreadcrumbCustom first="座位预约管理" second="预约设置2" />
